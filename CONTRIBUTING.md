...
### 🐛 Report Bugs
- Found a bug? [Open an issue](https://github.com/Lumpkin15/tradingview-mcp/issues/new)
- Include reproduction steps, expected vs actual behavior
- Provide system info (OS, Python version, UV version)

### 💡 Suggest Features
- Have an idea? [Create a feature request](https://github.com/Lumpkin15/tradingview-mcp/issues/new)
